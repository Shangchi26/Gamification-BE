...
<section class="bg-gray-100 min-h-screen w-full pl-6 sm:pl-[88px] pr-6 overflow-hidden font-inter">
        ...
        <h1 class="font-bold text-2xl leading-7 my-6">Item detail</h1>
        ...
        <div class="w-full bg-white rounded-lg shadow my-4 p-6">
            ...
            <div class="w-full max-w-md py-2">
                <h3 class="text-sm leading-5 font-medium">Item name: {{ $item->name }}</h3>
            </div>
            <div class="w-full max-w-md py-2">
                <h3 class="text-sm leading-5 font-medium">Type: {{ $item->type }}</h3>
            </div>
            <div class="w-full max-w-md py-2">
                <h3 class="text-sm leading-5 font-medium">Point: {{ $item->point }}</h3>
            </div>
        </div>
    </section>
@endsection
